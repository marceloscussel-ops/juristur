    ...
    <div className="min-h-screen bg-navy flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-6 py-20">
        ...
        <div className="text-center max-w-3xl">
          ...
          <h1 className="font-display text-[42px] sm:text-[54px] font-medium text-white leading-tight mb-6">
            Análise jurídica baseada em casos reais — em segundos
          </h1>
          <p className="text-white/60 text-[16px] max-w-xl mx-auto leading-relaxed mb-10">
        ...
        <div className="mt-16 w-full max-w-4xl bg-gold/10 border border-gold/30 rounded-xl p-6 sm:p-8 flex flex-col sm:flex-row gap-6 items-start">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {[
                ...
                <li key={item} className="flex items-start gap-2 text-white/70 text-[13px]">
